    ...
    steps: [
      {
        ...
        objects: { lens: "folder", acts: [WRITE, STORE, PICK], fresh: 2, focus: ["HEAD", "index"], note: "one file added, one index entry" }
      },
      {
        ...
        objects: { lens: "folder", acts: [WRITE, STORE, PICK], fresh: 0, focus: ["index"], note: "a binary file, starts with DIRC" }
      },
      {
        ...
        objects: { lens: "folder", acts: [WRITE, STORE, PICK], fresh: 0, focus: ["index/notes.md"], note: "path -> blob id + mode" }
      },
      {
        ...
        objects: { lens: "folder", acts: TWO_FILES, fresh: 1, focus: ["index/notes.md", "index/plan.md"], note: "two files, two entries" }
      },
      {
        ...
        objects: { lens: "folder", acts: TWO_FILES.concat([LIST, SAVE, NAME]), fresh: 1, focus: ["tree", "index"], note: "index becomes a tree on commit" }
      },
      {
        ...
        objects: { lens: "folder", acts: TWO_FILES.concat([LIST, SAVE, NAME]), fresh: 0, focus: ["index"], note: "the layer between working tree and commit" }
      },
      {
        ...
        objects: { lens: "folder", acts: SETUP, fresh: 0, detail: "full", focus: ["config"], note: "config holds settings, not objects" }
      }
    ]
  };
})();

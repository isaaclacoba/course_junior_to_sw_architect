  ...
  window.LESSON_CONFIG = {
    ...
    steps: [
      ...
      },
      {
        ...
        objects: { lens: "folder", acts: SETUP, fresh: 0, note: "HEAD points at a ref" }
      },
      {
        ...
        objects: { lens: "folder", acts: SETUP.concat(BRANCH_FEATURE, SWITCH_FEATURE), fresh: 0, note: "switched to feature" }
      },
      {
        ...
        objects: { lens: "folder", acts: SETUP.concat(BRANCH_FEATURE, SWITCH_FEATURE, SWITCH_MASTER), fresh: 0, note: "switched back to master" }
      },
      {
        ...
        objects: { lens: "folder", acts: SETUP.concat(DETACH), fresh: 0, note: "detached HEAD, 41 bytes" }
      },
      {
        ...
        objects: { lens: "folder", acts: SETUP.concat(DETACH), fresh: 0, note: "one name, two modes" }
      },
      {

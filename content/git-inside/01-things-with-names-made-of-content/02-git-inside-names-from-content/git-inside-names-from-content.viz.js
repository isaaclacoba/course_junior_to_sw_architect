  ...
  window.LESSON_CONFIG = {
    ...
    steps: [
      ...
      },
      {
        ...
        objects: { lens: "folder", acts: [WRITE, STORE], fresh: 0, note: "the name is calculated from the contents" }
      },
      {
      ...
      },
      {
        ...
        objects: { lens: "folder", acts: [WRITE, STORE, COPY, STORE_COPY, SHOUT, STORE_SHOUT], fresh: 0, note: "3b/18e512... is one name, filed in two parts" }
      }
    ]
  };
})();

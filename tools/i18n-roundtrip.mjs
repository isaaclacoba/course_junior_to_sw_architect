...
function staticRoundTrip(dir) {
  ...
  const ctx = { page };
  if (arch === "viz") ctx.viz = win.LESSON_VIZ;
  else if (arch === "build") ctx.config = win.BUILD_CONFIG;
  else if (arch === "checkpoint") ctx.quiz = win.QUIZ_CONFIG || win.CHECKPOINT_CONFIG;
